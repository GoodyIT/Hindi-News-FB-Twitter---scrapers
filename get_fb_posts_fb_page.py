...
app_id = "628848567285785"
app_secret = "45c8b53d968b20499c3132c5571c452b"  # DO NOT SHARE WITH ANYONE!
page_id = "navbharattimes"
...
def processFacebookPageFeedStatus(status, id):
    ...
    return (status_id, status_message, link_name)
...
def scrapeFacebookPageFeedStatus(page_id, access_token, since_date, until_date):
    with open('{}_facebook_statuses.csv'.format(page_id), 'w') as file:
        w = csv.writer(file)
        w.writerow(["connector", "status_message", "link_name"])
        ...
        while has_next_page:
            ...
            for status in statuses['data']:
                ...
                if 'reactions' in status:
                    status_data = processFacebookPageFeedStatus(status, primary_key)
                    primary_key += 1
